...
class _MyDiaryScreenState extends State<MyDiaryScreen>
  ...
  void addAllListData() {
    ...
    listViews.add(
      TitleView(
        titleTxt: 'Need Assistance? Call Me',
        subTxt: 'NOW',
        animation: Tween<double>(begin: 0.0, end: 1.0).animate(CurvedAnimation(
            parent: widget.animationController!,
  ...
  Widget build(BuildContext context) {
    return Container(
      color: Color.fromARGB(255, 235, 204, 246),
      child: Scaffold(
              ...
              child: Transform(
                ...
                child: Container(
                  decoration: BoxDecoration(
                    color: const Color.fromARGB(255, 221, 135, 255)
